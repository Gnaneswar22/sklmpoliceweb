...
<div class="dashboard">
    ...
    <main class="content">
        ...
        <div class="about-section-grid">
            <?php
            $sql = "SELECT * FROM about_section ORDER BY id DESC";
            ...
            while($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="about-section-item">
                    <div class="about-section-info">
                        ...
                        <div class="about-section-tagline">
                        ...
                        <div class="timestamp">
                            Created: <?php echo date('Y-m-d H:i:s', strtotime($row['created_at'])); ?>
                        </div>
                    </div>
            ...
            if(mysqli_num_rows($result) == 0) {
                echo "<p class='no-items'>No about sections found.</p>";
            }
            ?>
        </div>
    </main>
