...
$timeString = "<local_time>2024-12-12 13:32:38 in YYYY-MM-DD HH:mm:ss format</local_time>";
?>
        ...
        <main class="content">
            ...
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM hero_slides ORDER BY order_position";
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td class="slide-title"><?php echo htmlspecialchars($row['title']); ?></td>
                                <td class="slide-title"><?php echo htmlspecialchars($row['subtitle']); ?></td>
                        ...
                        if(mysqli_num_rows($result) == 0) {
                            echo "<tr><td colspan='6' class='no-records'>No slides found</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
        ...
        if(confirm('Do you want to restore the last deleted slide?')) {
            ...
            .then(data => {
                if(data.success) {
                    ...
                    alert(data.message || 'Unable to restore the slide');
                }
            })
            .catch(error => {
                console.error('Error:', error);
                alert('An error occurred while trying to restore the slide');
            });
        }
    }
