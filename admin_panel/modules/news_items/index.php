...
<head>
    ...
    <title>News Items Management</title>
...
<body>
        ...
        <main class="content">
            ...
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM news_items ORDER BY news_date DESC";
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($row['news_date']); ?></td>
                                <td>
                        ...
                        if(mysqli_num_rows($result) == 0) {
                            echo "<tr><td colspan='5' style='text-align: center;'>No news items found.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
    ...
    <script>
    function undoDelete() {
        if(confirm('Do you want to restore the last deleted news item?')) {
            fetch('undo.php', {
                method: 'POST',
                headers: {
